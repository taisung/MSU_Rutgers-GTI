...
dir = '/mnt/scratch/songlin3/run/thrombin/ligand_final/final/7a_resp/wat/ti_one-step/7a_1b/'
filesdir = dir + 'files/'
...
for j in lambd:
  ...
  #top
  os.system("cp ../7a-1b_merged.prmtop .")
  os.system("cp ../7a-1b_merged.inpcrd .")
  #submit pbs 
