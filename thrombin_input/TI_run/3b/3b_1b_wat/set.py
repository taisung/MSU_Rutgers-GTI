...
dir = '/mnt/scratch/songlin3/run/thrombin/ligand_final/final/3b_resp/wat/ti_one-step/3b_1b/'
filesdir = dir + 'files/'
...
for j in lambd:
  ...
  #top
  os.system("cp ../3b-1b_merged.prmtop .")
  os.system("cp ../3b-1b_merged.inpcrd .")
  #submit pbs 
