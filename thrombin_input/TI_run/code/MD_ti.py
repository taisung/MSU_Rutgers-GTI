...
for i in res1list:
  res2='I'+ i.upper()
  wdir = dir + "%s_resp/MD/"%(i)
  os.chdir(wdir)
  os.system("cpptraj thrombin_%s.prmtop < ptraj.in > out" %(res2))
  os.system("rm -r ti_one-step")
  os.system("cp -r ../../code/MD_code ti_one-step")
  ...
  for line in pdb:
    newlist = []
    newlist = line.split()
    if len(newlist) > 4 and  newlist[3] != "Na+" and newlist[3] != "WAT":
       protein.write(line)
    elif newlist[0] == "TER" and newlist[2] !="Na+" and newlist[2] != "WAT":
       protein.write(line)
  iowat = open('ions_wat.pdb','w')
  for line in pdb:
    newlist = []
    newlist = line.split()
    if newlist[0] == "TER" and (newlist[2] == "Na+" or newlist[2] == "WAT"):
       iowat.write(line)
    if newlist[0] !="TER" and newlist[0] !="END" and (newlist[3] == "Na+" or newlist[3] == "WAT"):
       iowat.write(line)
