...
dir = '/mnt/scratch/songlin3/run/thrombin/ligand_final/final/1d_resp/wat/ti_one-step/1d_6e/'
filesdir = dir + 'files/'
...
for j in lambd:
  ...
  #top
  os.system("cp ../1d-6e_merged.prmtop .")
  os.system("cp ../1d-6e_merged.inpcrd .")
  #submit pbs 
