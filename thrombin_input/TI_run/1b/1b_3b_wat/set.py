...
dir = '/mnt/scratch/songlin3/run/thrombin/ligand_final/final/1b_resp/wat/ti_one-step/1b_3b/'
filesdir = dir + 'files/'
...
for j in lambd:
  ...
  #top
  os.system("cp ../1b-3b_merged.prmtop .")
  os.system("cp ../1b-3b_merged.inpcrd .")
  #submit pbs 
