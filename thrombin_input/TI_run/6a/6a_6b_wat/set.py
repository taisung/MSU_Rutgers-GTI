...
dir = '/mnt/scratch/songlin3/run/thrombin/ligand_final/final/6a_resp/wat/ti_one-step/6a_6b/'
filesdir = dir + 'files/'
...
for j in lambd:
  ...
  #top
  os.system("cp ../6a-6b_merged.prmtop .")
  os.system("cp ../6a-6b_merged.inpcrd .")
  #submit pbs 
