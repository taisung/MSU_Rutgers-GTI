...
dir = '/mnt/scratch/songlin3/run/thrombin/ligand_final/final/7a_resp/wat/ti_one-step/7a_1d/'
filesdir = dir + 'files/'
...
for j in lambd:
  ...
  #top
  os.system("cp ../7a-1d_merged.prmtop .")
  os.system("cp ../7a-1d_merged.inpcrd .")
  #submit pbs 
