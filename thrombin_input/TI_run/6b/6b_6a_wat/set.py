...
dir = '/mnt/scratch/songlin3/run/thrombin/ligand_final/final/6b_resp/wat/ti_one-step/6b_6a/'
filesdir = dir + 'files/'
...
for j in lambd:
  ...
  #top
  os.system("cp ../6b-6a_merged.prmtop .")
  os.system("cp ../6b-6a_merged.inpcrd .")
  #submit pbs 
