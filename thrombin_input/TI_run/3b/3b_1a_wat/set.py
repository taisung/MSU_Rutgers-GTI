...
dir = '/mnt/scratch/songlin3/run/thrombin/ligand_final/final/3b_resp/wat/ti_one-step/3b_1a/'
filesdir = dir + 'files/'
...
for j in lambd:
  ...
  #top
  os.system("cp ../3b-1a_merged.prmtop .")
  os.system("cp ../3b-1a_merged.inpcrd .")
  #submit pbs 
