...
dir = '/mnt/scratch/songlin3/run/thrombin/ligand_final/final/3a_resp/wat/ti_one-step/3a_1d/'
filesdir = dir + 'files/'
...
for j in lambd:
  ...
  #top
  os.system("cp ../3a-1d_merged.prmtop .")
  os.system("cp ../3a-1d_merged.inpcrd .")
  #submit pbs 
