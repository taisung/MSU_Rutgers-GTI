...
dir = '/mnt/scratch/songlin3/run/thrombin/ligand_final/final/1b_resp/wat/ti_one-step/1b_1c/'
filesdir = dir + 'files/'
...
for j in lambd:
  ...
  #top
  os.system("cp ../1b-1c_merged.prmtop .")
  os.system("cp ../1b-1c_merged.inpcrd .")
  #submit pbs 
