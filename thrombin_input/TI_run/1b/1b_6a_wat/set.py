...
dir = '/mnt/scratch/songlin3/run/thrombin/ligand_final/final/1b_resp/wat/ti_one-step/1b_6a/'
filesdir = dir + 'files/'
...
for j in lambd:
  ...
  #top
  os.system("cp ../1b-6a_merged.prmtop .")
  os.system("cp ../1b-6a_merged.inpcrd .")
  #submit pbs 
