...
dir = '/mnt/scratch/songlin3/run/thrombin/ligand_final/final/TTT_resp/wat/ti_one-step/TTT_YYY/'
filesdir = dir + 'files/'
...
for j in lambd:
  ...
  #top
  os.system("cp ../TTT-YYY_merged.prmtop .")
  os.system("cp ../TTT-YYY_merged.inpcrd .")
  #submit pbs 
