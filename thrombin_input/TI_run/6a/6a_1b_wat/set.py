...
dir = '/mnt/scratch/songlin3/run/thrombin/ligand_final/final/6a_resp/wat/ti_one-step/6a_1b/'
filesdir = dir + 'files/'
...
for j in lambd:
  ...
  #top
  os.system("cp ../6a-1b_merged.prmtop .")
  os.system("cp ../6a-1b_merged.inpcrd .")
  #submit pbs 
