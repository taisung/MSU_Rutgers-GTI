...
dir = '/mnt/scratch/songlin3/run/thrombin/ligand_final/final/1c_resp/wat/ti_one-step/1c_1d/'
filesdir = dir + 'files/'
...
for j in lambd:
  ...
  #top
  os.system("cp ../1c-1d_merged.prmtop .")
  os.system("cp ../1c-1d_merged.inpcrd .")
  #submit pbs 
