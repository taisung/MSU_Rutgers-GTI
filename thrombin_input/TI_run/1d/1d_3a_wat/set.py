...
dir = '/mnt/scratch/songlin3/run/thrombin/ligand_final/final/1d_resp/wat/ti_one-step/1d_3a/'
filesdir = dir + 'files/'
...
for j in lambd:
  ...
  #top
  os.system("cp ../1d-3a_merged.prmtop .")
  os.system("cp ../1d-3a_merged.inpcrd .")
  #submit pbs 
