...
dir = '/mnt/scratch/songlin3/run/thrombin/ligand_final/final/1c_resp/wat/ti_one-step/1c_1b/'
filesdir = dir + 'files/'
...
for j in lambd:
  ...
  #top
  os.system("cp ../1c-1b_merged.prmtop .")
  os.system("cp ../1c-1b_merged.inpcrd .")
  #submit pbs 
