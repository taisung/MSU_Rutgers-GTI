...
dir = '/mnt/scratch/songlin3/run/thrombin/ligand_final/final/6e_resp/wat/ti_one-step/6e_6b/'
filesdir = dir + 'files/'
...
for j in lambd:
  ...
  #top
  os.system("cp ../6e-6b_merged.prmtop .")
  os.system("cp ../6e-6b_merged.inpcrd .")
  #submit pbs 
